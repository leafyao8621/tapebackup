...
static PyObject* report_list(PyObject* self, PyObject* args) {
    const char *beginning;
    const char *ending;
    const char *format;
    const char *export_file_name;
...
static PyObject* report_lookup(PyObject* self, PyObject* args) {
    const char *path;
    const char *format;
    const char *export_file_name;
    if (
...
static PyObject* report_transaction(PyObject* self, PyObject* args) {
    const char *beginning;
    const char *ending;
    const char *format;
    const char *export_file_name;
...
static PyMethodDef _base_methods[] = {
    ...
    {"report_list", (PyCFunction)report_list, METH_VARARGS, NULL},
    {"report_lookup", (PyCFunction)report_lookup, METH_VARARGS, NULL},
    {"report_transaction", (PyCFunction)report_transaction, METH_VARARGS, NULL},
    {0}
};
